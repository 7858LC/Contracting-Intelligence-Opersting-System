...
const VENTURES = [
  ...
  {
    name: "Leadflow",
    category: "Trades · Lead Network",
    desc: "Demand generated by Fieldbook vendors returned as pre-qualified leads. Every quote sent is an impression. Those impressions become your next job.",
    href: null,
    icon: TrendingUp,
  ...
  },
  {
    ...
    desc: "Twelve pre-built n8n workflows for trade businesses — lead capture, invoice reminders, support triage, social calendar, and weekly reporting. Import in one click. $49, one time.",
    href: "https://gumroad.com/l/prbymh",
    icon: Zap,
    status: "live" as const,
  },
  {
  ...
  },
  {
    ...
    desc: "Market-rate quoting for trade professionals. Live pricing benchmarks from 50,000+ jobs — HVAC, landscaping, plumbing, and more. Send approval links. Invoice same day.",
    href: null,
    icon: Calculator,
    status: "soon" as const,
  },
